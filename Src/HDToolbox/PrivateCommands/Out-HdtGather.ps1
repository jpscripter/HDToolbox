...
.DESCRIPTION
The Send-HdtGather cmdlet accepts a list of file paths to gather, copies them into a temporary folder, compresses them into a ZIP archive, and saves the archive to the specified destination. The temporary folder is cleaned up after the operation.
...
.EXAMPLE
Out-HdtGather -FilesToGather @("C:\Path\To\File1.txt", "C:\Path\To\File2.txt") -ZipFilePath "C:\Path\To\Output.zip"
